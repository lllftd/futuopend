...
from options.futu_options_data import FutuOptionDataClient, OptionHistoryRequest
...
from options.options_execution_model import ContractSelectorConfig, select_option_contract_for_signal
...
def load_best_rule_params(ranking_path: Path, symbols: tuple[str, ...]) -> dict[str, RuleParams]:
    try:
        return load_ranked_rule_params(
            ranking_path,
            symbols,
            required_columns={
                "ce_length",
