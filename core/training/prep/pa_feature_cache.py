...
from core.training.common.constants import LABELED_SUFFIX, PA_TIMEFRAMES_RAW

# Bump when PA column contract changes (e.g. straddle / vol_regime prep). Old caches miss
# ``pa_volume_zscore`` and similar; meta mtime alone may not invalidate copied trees.
PA_FEATURE_CACHE_SCHEMA = 3
...
def _pa_cache_meta(raw_path: str, timeframe: str) -> dict[str, int | str]:
    ...
    return {
        ...
        "timeframe": timeframe,
        "pa_timeframes": PA_TIMEFRAMES_RAW,
