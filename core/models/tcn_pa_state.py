...
from core.training.common.constants import TCN_BOTTLENECK_DIM
    ...
    def forward(
        ...
        *,
        ...
        if attn_rows.any():
            ...
            pooled_sub = torch.sum(seq_sub * attn_weights.unsqueeze(-1), dim=1).to(dtype=pooled.dtype)
            pooled[attn_rows] = pooled_sub
