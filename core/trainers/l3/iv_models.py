...
def build_base_iv_series(
    ...
    *,
    ...
    base_mode = (os.environ.get("L3_STRADDLE_BASE_IV_MODEL", "garch") or "garch").strip().lower()
    ...
    risk_premium = float(np.clip(float(os.environ.get("L3_STRADDLE_IV_RISK_PREMIUM", "0.02")), 0.0, 1.0))
