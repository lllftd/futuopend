...
#   ./scripts/training/run_layer1a_gpu_fresh.sh
#   USE_PREPARED=1 ./scripts/training/run_layer1a_gpu_fresh.sh
#   REBUILD_PREP=1 ./scripts/training/run_layer1a_gpu_fresh.sh
#
# Fast wall-clock preset (env-only; target under ~2h on MPS — tune to your machine):
#   L1A_FAST=1 TORCH_DEVICE=mps ./scripts/training/run_layer1a_gpu_fresh.sh
...
#   L1A_OOF_WARMSTART=1 L1A_WARMSTART_OOF_MAX_EPOCHS=24 L1A_WARMSTART_OOF_LR_SCALE=0.5 ./scripts/training/run_layer1a_gpu_fresh.sh
